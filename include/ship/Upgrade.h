...
class Upgrade{
 ...
 public:
  Upgrade(Upgrade_ID upgrade_id, Price initial_price, double increase_factor);
  Upgrade(Upgrade_ID upgrade_id, Price initial_price);
  Upgrade(Upgrade_ID upgrade_id, Price initial_price, double increase_factor, std::vector<Upgrade_ID> dependencies);
  Upgrade(Upgrade_ID upgrade_id, Price initial_price, std::vector<Upgrade_ID> dependencies);
  ~Upgrade();
